    ...
    return(
        ...
        className={`fixed inset-0 ${openForm ? "z-50":"z-30"} flex items-center justify-center bg-black/50 backdrop-blur-sm`}>
                ...
                >
                    ...
                    <p className="text-slate-500 text-sm font-medium">Nama Customers: {namaCustomer}</p>
                    <p className="text-slate-500 text-sm font-medium">ID Customers: {id}</p>
                    <p className="text-slate-500 text-sm font-medium">Nomor Induk KTP: {nik}</p>
                    <p className="text-slate-500 text-sm font-medium">Bergabung Pada: {dibuatPada}</p>
